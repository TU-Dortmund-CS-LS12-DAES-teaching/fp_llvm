; ModuleID = 'src/qsort-exam.c'
source_filename = "src/qsort-exam.c"
...
25:                                               ; preds = %21
  ...
  %27 = getelementptr inbounds [20 x float], [20 x float]* @arr, i64 0, i64 %26
...
35:                                               ; preds = %31
  ...
  %37 = getelementptr inbounds [20 x float], [20 x float]* @arr, i64 0, i64 %36
...
42:                                               ; preds = %35
  ...
  %44 = getelementptr inbounds [20 x float], [20 x float]* @arr, i64 0, i64 %43
...
52:                                               ; preds = %41, %31
  ...
  %55 = add i64 %54, 1
  %56 = getelementptr inbounds [20 x float], [20 x float]* @arr, i64 0, i64 %55
...
64:                                               ; preds = %60
  ...
  %68 = getelementptr inbounds [100 x i32], [100 x i32]* @istack, i64 0, i64 %67
  ...
  %74 = getelementptr inbounds [100 x i32], [100 x i32]* @istack, i64 0, i64 %73
...
77:                                               ; preds = %13
  ...
  %86 = add i64 %85, 1
  %87 = getelementptr inbounds [20 x float], [20 x float]* @arr, i64 0, i64 %86
  ...
  %93 = add i64 %92, 1
  %94 = getelementptr inbounds [20 x float], [20 x float]* @arr, i64 0, i64 %93
...
137:                                              ; preds = %123, %114
  ...
  %139 = getelementptr inbounds [20 x float], [20 x float]* @arr, i64 0, i64 %138
  %140 = load float, float* %139, align 4
  %141 = load i64, i64* %7, align 8
  %142 = add i64 %141, 1
  %143 = getelementptr inbounds [20 x float], [20 x float]* @arr, i64 0, i64 %142
...
146:                                              ; preds = %137
  ...
  %148 = getelementptr inbounds [20 x float], [20 x float]* @arr, i64 0, i64 %147
  %149 = load float, float* %148, align 4
  store float %149, float* %11, align 4
  %150 = load i64, i64* %7, align 8
  %151 = add i64 %150, 1
  %152 = getelementptr inbounds [20 x float], [20 x float]* @arr, i64 0, i64 %151
  %153 = load float, float* %152, align 4
  %154 = load i64, i64* %7, align 8
  %155 = getelementptr inbounds [20 x float], [20 x float]* @arr, i64 0, i64 %154
  store float %153, float* %155, align 4
  %156 = load float, float* %11, align 4
  %157 = load i64, i64* %7, align 8
  %158 = add i64 %157, 1
  %159 = getelementptr inbounds [20 x float], [20 x float]* @arr, i64 0, i64 %158
...
160:                                              ; preds = %146, %137
  ...
  %165 = add i64 %164, 1
  %166 = getelementptr inbounds [20 x float], [20 x float]* @arr, i64 0, i64 %165
...
171:                                              ; preds = %177, %168
  ...
  %173 = getelementptr inbounds [20 x float], [20 x float]* @arr, i64 0, i64 %172
...
183:                                              ; preds = %189, %180
  ...
  %185 = getelementptr inbounds [20 x float], [20 x float]* @arr, i64 0, i64 %184
...
197:                                              ; preds = %192
  ...
  %199 = getelementptr inbounds [20 x float], [20 x float]* @arr, i64 0, i64 %198
  %200 = load float, float* %199, align 4
  store float %200, float* %11, align 4
  %201 = load i64, i64* %5, align 8
  %202 = getelementptr inbounds [20 x float], [20 x float]* @arr, i64 0, i64 %201
  %203 = load float, float* %202, align 4
  %204 = load i64, i64* %3, align 8
  %205 = getelementptr inbounds [20 x float], [20 x float]* @arr, i64 0, i64 %204
  store float %203, float* %205, align 4
  %206 = load float, float* %11, align 4
  %207 = load i64, i64* %5, align 8
  %208 = getelementptr inbounds [20 x float], [20 x float]* @arr, i64 0, i64 %207
  store float %206, float* %208, align 4
  br label %168

209:                                              ; preds = %196
  %210 = load i64, i64* %5, align 8
  %211 = getelementptr inbounds [20 x float], [20 x float]* @arr, i64 0, i64 %210
  %212 = load float, float* %211, align 4
  %213 = load i64, i64* %7, align 8
  %214 = add i64 %213, 1
  %215 = getelementptr inbounds [20 x float], [20 x float]* @arr, i64 0, i64 %214
  store float %212, float* %215, align 4
  %216 = load float, float* %10, align 4
  %217 = load i64, i64* %5, align 8
  %218 = getelementptr inbounds [20 x float], [20 x float]* @arr, i64 0, i64 %217
...
229:                                              ; preds = %209
  ...
  %234 = getelementptr inbounds [100 x i32], [100 x i32]* @istack, i64 0, i64 %233
  ...
  %240 = getelementptr inbounds [100 x i32], [100 x i32]* @istack, i64 0, i64 %239
...
243:                                              ; preds = %209
  ...
  %249 = getelementptr inbounds [100 x i32], [100 x i32]* @istack, i64 0, i64 %248
  ...
  %255 = getelementptr inbounds [100 x i32], [100 x i32]* @istack, i64 0, i64 %254
